...
$sql = "SELECT * FROM jogo WHERE id_jogo IN(SELECT id_jogo FROM categoria_jogo WHERE id_cat IN(SELECT id_cat FROM categoria WHERE nm_cat='Ação')) ORDER BY id_jogo DESC";
$resultado = pg_query($conexao, $sql);
$resultado_array = pg_fetch_all($resultado);
?>

<h2 class="text-center">Jogos de Ação</h2>
		<div class="content">
			<div class="row">
